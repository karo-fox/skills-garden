...
class TestViews(APITestCase):
    ...
    def setUp(self):
        ...
        self.text_src = TextSource(name='new name', topic=self.topic, content='new content')
        self.url_src = URLSource(name='new name', topic=self.topic, content='https://www.google.com/')
        self.field.save()
        self.topic.save()
        self.text_src.save() 
        self.url_src.save()
